...
{
    public class SignalRParameterDataService
    {
        private IHubContext<SignalRParametersHub> hubContext { get; set; }
        ...
        public SignalRParameterDataService(IHubContext<SignalRParametersHub> hubCtx)
        {
            hubContext = hubCtx;
        }
        public IEnumerable<ParameterData> GetAllData(int ParamID)
        {
            ParameterID = ParamID;
